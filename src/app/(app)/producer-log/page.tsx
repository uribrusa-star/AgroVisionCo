      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            <Card>
                ...
                <CardContent>
                    <div className="text-xl font-bold">{loading ? <Skeleton className="h-7 w-20" /> : `$${totalIncome.toLocaleString('es-AR')}`}</div>
            ...
            <Card>
                ...
                <CardContent>
                    <div className="text-xl font-bold">{loading ? <Skeleton className="h-7 w-20" /> : `$${totalCost.toLocaleString('es-AR')}`}</div>
             ...
             <Card>
                ...
                <CardContent>
                    <div className={`text-xl font-bold ${grossMargin >= 0 ? 'text-green-600' : 'text-red-600'}`}>{loading ? <Skeleton className="h-7 w-20" /> : `$${grossMargin.toLocaleString('es-AR')}`}</div>
            ...
            <Card className="bg-primary/5">
                ...
                <CardContent>
                    <div className={`text-xl font-bold ${roi >= 0 ? 'text-primary' : 'text-red-600'}`}>{loading ? <Skeleton className="h-7 w-12" /> : `${roi.toFixed(1)}%`}</div>
            ...
            <Card>
                ...
                <CardContent>
                    <div className="text-xl font-bold">{loading ? <Skeleton className="h-7 w-16" /> : `$${costPerKg.toFixed(2)}`}</div>
            ...
            <Card>
                ...
                <CardContent>
                    <div className="text-xl font-bold">{loading ? <Skeleton className="h-7 w-20" /> : `$${totalLaborCost.toLocaleString('es-AR')}`}</div>
